...
cast send --rpc-url $ETH_RPC_URL --private-key $ETH_PRIVATE_KEY $YAB_TRANSFER_PROXY_ADDRESS "transfer(uint256, uint256, uint256)" "0" "$DESTINATION_ADDRESS_UINT" "$amount" --value $amount
