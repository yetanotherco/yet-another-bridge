...
contract YABTransfer_moreVars_middle is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    struct TransferInfo {
        uint256 destAddress;
        uint256 amount;
        bool isUsed;
    ...
    function getNewVarMiddle() external view returns (uint256) {
        return _newVarMiddle;
    }

    function setNewVarMiddle(uint256 newValue) external {
        _newVarMiddle = newValue;
    }
