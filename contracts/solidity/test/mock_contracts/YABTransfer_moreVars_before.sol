...
contract YABTransfer_moreVars_before is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    struct TransferInfo {
        uint256 destAddress;
        uint256 amount;
        bool isUsed;
    ...
    function getNewVarBefore() external view returns (uint256) {
        return _newVarBefore;
    }

    function setNewVarBefore(uint256 newValue) external {
        _newVarBefore = newValue;
    }
