...
#[starknet::interface]
trait IEscrow_moreVars_before<ContractState> {
    ...
    fn get_new_var_before(self: @ContractState) -> u256;
    fn set_new_var_before(ref self: ContractState, new_var_before: u256);
}

#[starknet::contract]
mod Escrow_moreVars_before {
    use super::{IEscrow_moreVars_before, Order};
    ...
    #[external(v0)]
    impl Escrow of IEscrow_moreVars_before<ContractState> {
        fn get_order(self: @ContractState, order_id: u256) -> Order {
        ...
        fn get_new_var_before(self: @ContractState) -> u256 {
            self.new_var_before.read()
        }
        fn set_new_var_before(ref self: ContractState, new_var_before: u256) {
            self.new_var_before.write(new_var_before);
        }
    }
