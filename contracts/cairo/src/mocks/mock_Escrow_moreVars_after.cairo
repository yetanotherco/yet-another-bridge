...
#[starknet::interface]
trait IEscrow_moreVars_after<ContractState> {
    ...
    fn get_new_var_after(self: @ContractState) -> u256;
    fn set_new_var_after(ref self: ContractState, new_var_after: u256);
}

#[starknet::contract]
mod Escrow_moreVars_after {
    use super::{IEscrow_moreVars_after, Order};
    ...
    #[external(v0)]
    impl Escrow of IEscrow_moreVars_after<ContractState> {
        fn get_order(self: @ContractState, order_id: u256) -> Order {
        ...
        fn get_new_var_after(self: @ContractState) -> u256 {
            self.new_var_after.read()
        }
        fn set_new_var_after(ref self: ContractState, new_var_after: u256) {
            self.new_var_after.write(new_var_after);
        }
