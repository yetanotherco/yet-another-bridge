...
MM_INITIAL_BALANCE=$(cast balance --rpc-url $ETH_RPC_URL --ether $MM_ETHEREUM_PUBLIC_ADDRESS)
DESTINATION_INITIAL_BALANCE=$(cast balance --rpc-url $ETH_RPC_URL --ether $USER_ETHEREUM_PUBLIC_ADDRESS)
...
cast send --rpc-url $ETH_RPC_URL --private-key $MM_ETHEREUM_PRIVATE_ADDRESS \
...
MM_FINAL_BALANCE=$(cast balance --rpc-url $ETH_RPC_URL --ether $MM_ETHEREUM_PUBLIC_ADDRESS)
DESTINATION_FINAL_BALANCE=$(cast balance --rpc-url $ETH_RPC_URL --ether $USER_ETHEREUM_PUBLIC_ADDRESS)
